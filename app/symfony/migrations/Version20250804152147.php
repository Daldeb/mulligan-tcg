 ...
 */
final class Version20250804152147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD deleted_by_id INT DEFAULT NULL, ADD deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5A8A6C8DC76F1F52 ON post');
        $this->addSql('ALTER TABLE post DROP deleted_by_id, DROP deleted_at');
    }
}
